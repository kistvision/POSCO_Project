...
class ESPCN(nn.Module):
    def __init__(
        ...
        # # Feature mapping
        # self.feature_maps = nn.Sequential(
        #     nn.Conv2d(in_channels, hidden_channels, (3, 3), (1, 1), (1, 1)),
        #     nn.Tanh(),
        #     nn.Conv2d(hidden_channels, channels, (5, 5), (1, 1), (2, 2)),
        #     nn.Tanh(),
        #     nn.Conv2d(channels, hidden_channels, (3, 3), (1, 1), (1, 1)),
        #     nn.Tanh(),
        # )
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        input_resized = nn.functional.interpolate(input, scale_factor=2, mode='bilinear', align_corners=False)
        # x = x + input_resized
